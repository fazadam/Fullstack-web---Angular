...
export const rountingComponents=[LoginComponentComponent,SignupComponentComponent,CardListComponentComponent,UserprofileComponent,GameComponentComponent]
